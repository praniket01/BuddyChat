...
import { getOutgoingFriendReq, getRecommendedUsers, getUserFriends, sendFriendReq } from "../lib/api";
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">
                  Discover perfect Buddy based on your profile.
                </p>
              </div>
            </div>
          </div>
